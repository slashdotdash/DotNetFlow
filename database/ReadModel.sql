...
CREATE TABLE Items (ItemId UNIQUEIDENTIFIER  NOT NULL PRIMARY KEY, PublishedAt DATETIME, SubmittedByUserId UNIQUEIDENTIFIER, SubmittedByUsername NVARCHAR(20), SubmittedByFullName NVARCHAR(200), Title NVARCHAR(140), HtmlContent NVARCHAR(2000), UrlSlug NVARCHAR(1000))
...
CREATE INDEX IX_Items_UrlSlug ON Items (UrlSlug) 
