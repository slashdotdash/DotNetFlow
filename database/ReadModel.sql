CREATE TABLE Users (UserId UNIQUEIDENTIFIER  NOT NULL PRIMARY KEY, RegisteredAt DATETIME, FullName NVARCHAR(200), Email NVARCHAR(1000), HashedPassword NCHAR(60), Website NVARCHAR(1000), Twitter NVARCHAR(200))
