CREATE TABLE Users (UserId UNIQUEIDENTIFIER  NOT NULL PRIMARY KEY, RegisteredAt DATETIME, FullName NVARCHAR(200), Email NVARCHAR(1000), HashedPassword NCHAR(40), PasswordSalt NCHAR(8), Website NVARCHAR(1000), Twitter NVARCHAR(200))
