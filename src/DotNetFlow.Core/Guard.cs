...
namespace DotNetFlow.Core
{
    /// <summary>
    /// Provides utility methods to guard parameter and local variables.
    /// </summary>
    /// <see cref="https://github.com/riteshrao/ncommon/blob/v1.2/NCommon/src/Guard.cs"/>
    public static class Guard
    {
        ...
        public static void Against<TException>(bool assertion, string message, params string[] args) where TException : Exception
        {
            if (assertion)
        ...
        /// <summary>
        /// Throws an exception of type <typeparamref name="TException"/> with the specified message when the assertion fails
        /// </summary>
        public static void Against<TException>(Func<bool> assertion, string message, params string[] args) where TException : Exception
        {
